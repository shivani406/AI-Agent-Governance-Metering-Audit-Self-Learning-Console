...
def add_governance_log(
    cursor, agent_id, action_taken: str, approved_by: str, reason: str
):
    cursor.execute("""
...
def add_usage_ledger(
    ...
    caller_agent: int,
    target_agent: int,
    caller_tokens_consumed: int,
    target_tokens_consumed: int,
):
    cursor.execute("""
    ...
    cursor.execute(
        ...
        (
            ...
            caller_agent,
            target_agent,
            caller_tokens_consumed,
            target_tokens_consumed,
            previous_hash,
            current_hash,
        ),
    )
...
def add_security_incident_log(
    cursor,
    incident_type: str,
    description: str,
    caller_agent: int = None,
